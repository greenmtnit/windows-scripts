<#
  ...
  Creates a text file on the public desktop with computer info: name, hostname, serial, and operating system.
...
# Change permissions to allow deletion of the file
